...
export const BotIcon = ({ className = "h-6 w-6", color = "text-white" }: { className?: string; color?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const DatabaseIcon = ({ className = "w-4 h-4", color = "text-teal-400" }: { className?: string; color?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={`${className} ${color}`}
    viewBox="0 0 24 24"
...
export const ClockIcon = ({ className = "w-4 h-4", color = "text-teal-400" }: { className?: string; color?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={`${className} ${color}`}
    viewBox="0 0 24 24"
